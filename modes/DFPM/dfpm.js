...
function flipTheSwitch({host, port, debug, runChrome}){
    ...
    if(runChrome){
        ...
        var cmd = runChrome=='false'?'chromium-browser':runChrome
        // var cmd = runChrome=='true'?'/Users/mukthy/Desktop/office/node-projects/chrome-mac/Chromium.app':runChrome
...
async function main(program){
    ...
    while(program.urls && program.urls.length){
        ...
        await sleep(10*5000) //make sure there is enough time to allow js to run
    }
    if(program.webhook){
