...
def start(url, user, slack_webhook_url, headers, response_url):
    out = subprocess.Popen(['node', '/Users/mukthy/Desktop/office/node-projects/puppeteer_dc.js', f'{url}', f'{user}.png'],
        ...
        "blocks": [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"@{user} Zyte Smartproxy Puppeteer screenshot for {url} is given below: \n",
                },
            },
            # {
            #     "type": "section",
